<!-- <div class="container red">
  <div class="nav">
    <ul class="row">
      ...
      <li Class="col-md-2 active"><a href="<?php echo site_url(); ?>">BERANDA</a></li>
      <li Class="col-md-2"><a href="<?php echo site_url('registration'); ?>">PENDAFTARAN</a></li>
    ...
    <div class="row">
        <div class="col-md-12 homePhoto white">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                  <img src="<?php echo base_url('assets/img/img-photo4.jpg') ?>" alt="Poster">
                  <div class="carousel-caption">
                    ...
                  </div>
                </div>
        ...
        <div class="col-md-6">
                    <img src="<?php echo base_url('assets/img/img-photo1.jpg') ?>">
